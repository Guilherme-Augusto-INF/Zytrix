-- Zytrix Firebase -> Supabase migration: relational foundation.
...
comment on table private.firebase_user_map is 'Stable Firebase UID to Supabase Auth UUID mapping.';
